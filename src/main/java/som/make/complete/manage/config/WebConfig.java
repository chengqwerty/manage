package som.make.complete.manage.config;
...
import som.make.complete.manage.config.condition.WindowsCondition;
import som.make.complete.manage.config.filter.HeadFilter;
...
public class WebConfig {
    ...
    @Bean
    @Conditional(WindowsCondition.class)
    public FilterRegistrationBean<Filter> registrationHeadFilter() {
